...
- Remove scheduled task UI entry.
- Remove duplicate MCP global sidebar entry.
...
- Align archived task typography with the Board and keep mobile project panels above the tab bar.
- Allow enriched Issues assigned to users and filter Issues by creator across local and Relay views.
...
## [0.4.10-beta.39] - 2026-08-27

- Keep agent creation inside a compact dialog.
- Preserve Issue session synchronization after handing a thread back to native Codex.
...
- Verify update completion against the serving Runtime and keep help commands read-only.
...
## [0.4.10-beta.22] - 2026-08-25

- Restore update, completion, Agent, project, label, and profile overlay layouts after extracting shared UI styles.
