export function betterCodexFeatureStructureStylesCss() {
  return String.raw`
    ...
    #better-codex-panel .better-codex-activity[data-run="retrying"] { max-width: 72%; color: color-mix(in oklch, var(--bc-color-warning) 82%, var(--bc-color-text)); }
    #better-codex-panel .better-codex-activity[data-run="retrying"] > span:last-child { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    ...
    #better-codex-panel .better-codex-project-dashboard-tabs-mobile { display: none; }
    ...
    @media (max-width: 980px) { #better-codex-panel .better-codex-project-summary, #better-codex-panel .better-codex-project-columns, #better-codex-panel .better-codex-project-dashboard-lists, #better-codex-panel .better-codex-project-planning-layout { grid-template-columns: 1fr; } #better-codex-panel .better-codex-project-dashboard-tabs-desktop { display: none; } #better-codex-panel .better-codex-project-dashboard-tabs-mobile { display: grid; width: 100%; grid-template-columns: repeat(4,minmax(0,1fr)); } #better-codex-panel .better-codex-project-dashboard-tabs.better-codex-project-dashboard-tabs-mobile button { min-width: 0; min-height: calc(var(--bc-control-height) + var(--bc-space-3)); padding-inline: var(--bc-space-2); } #better-codex-panel .better-codex-project-columns { height: auto; } #better-codex-panel .better-codex-project-panel:first-child { height: min(50dvh,480px); min-height: 320px; } #better-codex-panel .better-codex-project-document-panel { height: min(86dvh,820px); min-height: 620px; } #better-codex-panel .better-codex-project-planning-layout { min-height: 0; } #better-codex-panel .better-codex-project-planning-layout[data-project-planning-pane="plan"] .better-codex-project-planning-chat, #better-codex-panel .better-codex-project-planning-layout[data-project-planning-pane="chat"] .better-codex-project-plan { display: none; } #better-codex-panel .better-codex-project-plan, #better-codex-panel .better-codex-project-planning-chat { height: min(78dvh,760px); min-height: 560px; } #better-codex-panel .better-codex-project-planning-layout[data-project-planning-pane="chat"] .better-codex-project-planning-chat { height: clamp(420px,calc(100dvh - 270px),760px); min-height: 420px; } #better-codex-panel .better-codex-project-planning-form { padding-bottom: calc(var(--bc-space-3) + env(safe-area-inset-bottom)); } #better-codex-panel .better-codex-project-work-board { height: min(76dvh,760px); min-height: 520px; padding-inline: 0; } }
...
export function betterCodexFeatureStylesCss() {
  return String.raw`
    ...
    #better-codex-auto-dispatch-help-dialog .better-codex-help-model-menu.is-above {
      top: auto;
    ...
    #better-codex-panel .better-codex-board.is-panning,
    #better-codex-panel .better-codex-board.is-panning * {
    ...
    #better-codex-panel .better-codex-board-scroll > :is(span, button) {
      display: inline-flex;
      width: var(--bc-icon-sm);
      height: var(--bc-icon-sm);
      flex: 0 0 var(--bc-icon-sm);
      ...
      color: inherit;
      cursor: pointer;
      transition: color var(--bc-motion-fast);
    }

    #better-codex-panel .better-codex-board-scroll > :is(span, button):hover {
      color: var(--bc-color-text);
    }

    #better-codex-panel .better-codex-board-scroll > :is(span, button):focus-visible {
      outline: none;
      color: var(--bc-color-text);
      box-shadow: var(--bc-focus-ring);
    }

    #better-codex-panel .better-codex-board-scroll > :is(span, button).is-start {
      transform: rotate(180deg);
    }
    ...
    #better-codex-panel .better-codex-board-scroll input::-webkit-slider-runnable-track {
      height: var(--bc-board-scroll-track-size);
      border-radius: var(--bc-radius-pill);
      background: var(--bc-color-control);
      box-shadow: var(--bc-inset-hairline);
    }
    ...
    #better-codex-panel .better-codex-board-scroll input::-webkit-slider-thumb {
      ...
      cursor: grab;
      transition: background-color var(--bc-motion-fast);
    }

    #better-codex-panel .better-codex-board-scroll input::-webkit-slider-thumb:active {
      cursor: grabbing;
      background: var(--bc-color-surface);
    }
    ...
    #better-codex-dialog .better-codex-conversation-status .better-codex-activity[data-run="retrying"] {
      color: color-mix(in oklch, var(--bc-color-warning) 82%, var(--bc-color-text));
    }
    ...
    #better-codex-dialog .better-codex-thinking-card {
      display: block;
      margin-top: var(--bc-space-2);
      margin-bottom: var(--bc-space-3);
      border-radius: var(--bc-radius-md);
    ...
    #better-codex-dialog .better-codex-thinking-summary {
      display: flex;
      align-items: center;
      gap: var(--bc-space-2);
    ...
    #better-codex-dialog .better-codex-thinking-summary::-webkit-details-marker {
      display: none;
    }

    #better-codex-dialog .better-codex-thinking-summary:hover {
      background: var(--bc-color-hover);
      color: var(--bc-color-text);
    }

    #better-codex-dialog .better-codex-thinking-icon {
      display: flex;
      align-items: center;
      justify-content: center;
      width: var(--bc-text-base);
      height: var(--bc-text-base);
      flex: 0 0 var(--bc-text-base);
      color: var(--bc-color-text-faint);
    }

    #better-codex-dialog .better-codex-thinking-title {
      font-weight: 590;
      color: var(--bc-color-text);
    }

    #better-codex-dialog .better-codex-thinking-badge {
      color: var(--bc-color-text-faint);
      font-size: var(--bc-text-xs);
    }

    #better-codex-dialog .better-codex-thinking-chevron {
      display: flex;
      align-items: center;
      margin-left: auto;
      color: var(--bc-color-text-faint);
    ...
    #better-codex-dialog .better-codex-thinking-card[open] > .better-codex-thinking-summary .better-codex-thinking-chevron {
      transform: rotate(180deg);
    }
    ...
    #better-codex-dialog .better-codex-thinking-steps {
      display: flex;
      flex-direction: column;
      gap: var(--bc-space-1);
      margin: 0;
    ...
    #better-codex-dialog .better-codex-thinking-step {
      display: flex;
      align-items: center;
      gap: var(--bc-space-2);
    ...
    #better-codex-dialog .better-codex-thinking-step-icon {
      display: flex;
      align-items: center;
      flex: 0 0 var(--bc-text-sm);
      color: var(--bc-color-text-faint);
    }

    #better-codex-dialog .better-codex-thinking-step-title {
      flex: 1;
      min-width: 0;
      white-space: nowrap;
      overflow: hidden;
    ...
    #better-codex-dialog .better-codex-thinking-step-duration {
      flex: 0 0 auto;
      color: var(--bc-color-text-faint);
      font-size: var(--bc-text-2xs);
    }

    #better-codex-dialog .better-codex-thinking-step-status {
      display: flex;
      align-items: center;
      flex: 0 0 var(--bc-text-sm);
      color: var(--bc-color-text-faint);
    ...
    #better-codex-dialog .better-codex-thinking-step.completed .better-codex-thinking-step-status {
      color: var(--bc-color-success);
    }

    #better-codex-dialog .better-codex-thinking-step.failed .better-codex-thinking-step-status {
      color: var(--bc-color-danger);
    }
    ...
    #better-codex-dialog .better-codex-session-retry {
      display: flex;
      flex: 0 0 auto;
      align-items: center;
      gap: var(--bc-space-3);
      margin: var(--bc-space-2) var(--bc-dialog-content-gutter) 0;
      border: 1px solid color-mix(in oklch, var(--bc-color-warning) 32%, transparent);
      border-radius: var(--bc-radius-sm);
      color: color-mix(in oklch, var(--bc-color-warning) 82%, var(--bc-color-text));
    ...
    #better-codex-dialog .better-codex-session-retry-icon {
      display: inline-flex;
      width: 24px;
      height: 24px;
      flex: 0 0 24px;
    ...
    #better-codex-dialog .better-codex-session-retry-icon svg {
      width: 16px;
      height: 16px;
    }

    #better-codex-dialog .better-codex-session-retry > div:not(.better-codex-session-retry-actions) {
      display: flex;
      min-width: 0;
      flex: 1;
      flex-direction: column;
      gap: calc(var(--bc-space-1) / 2);
      font-size: var(--bc-text-sm);
      line-height: normal;
    }

    #better-codex-dialog .better-codex-session-retry strong {
      color: var(--bc-color-text);
      font-size: var(--bc-text-md);
      font-weight: 650;
    }

    #better-codex-dialog .better-codex-session-retry-actions {
      display: flex;
      flex: 0 0 auto;
      gap: var(--bc-space-2);
    }

    #better-codex-dialog .better-codex-session-retry-actions button {
      border: 1px solid color-mix(in oklch, var(--bc-color-warning) 36%, transparent);
      border-radius: var(--bc-radius-xs);
      color: inherit;
      background: transparent;
      padding: var(--bc-space-1) var(--bc-space-2);
    ...
    @media (max-width: 640px) {
      ...
      #better-codex-dialog .better-codex-session-retry-actions {
        width: 100%;
        box-sizing: border-box;
        padding-left: calc(var(--bc-space-7) + var(--bc-space-2));
      }
    }
