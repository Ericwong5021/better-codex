...
import { cdpPort, ensureDirectories, gatewayLogPath, logPath, port, tiloHome } from "./config.js";

const label = "com.tilo.gateway";
...
<key>TILO_HOME</key><string>${xml(tiloHome)}</string>
<key>TILO_PORT</key><string>${port}</string>
<key>TILO_CDP_PORT</key><string>${cdpPort}</string>
</dict>
<key>WorkingDirectory</key><string>${xml(tiloHome)}</string>
