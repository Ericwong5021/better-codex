...
export const remoteCommandOperations = ["project.pick_directory", "project.browse_directory", "project.create_directory", "project.create", "project.delete", "project.overview", "project.planning.reply", "project.planning.reset", "issue.create", "issue.update", "issue.move", "issue.start", "issue.stop", "issue.regenerate-title", "issue.reply", "issue.queue.update", "issue.queue.send", "issue.queue.delete", "issue.archive", "issue.restore", "issue.delete", "settings.auto-dispatch"] as const;
