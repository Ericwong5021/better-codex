...
try {
  ...
  const issueProjection = { id: "deployment-issue", identifier: "DEP-1", project_id: projectProjection.id, title: "Container synchronized", description: "Acceptance", status: "todo", priority: "medium", labels: [], sort_order: 0, pinned: false, archived_at: null, assigned: false, agent_enabled: false, agent_id: null, user_assigned: false, pending_actor: "user", active_run: false, needs_attention: false, created_at: timestamp, updated_at: timestamp, local_revision: 1 };
